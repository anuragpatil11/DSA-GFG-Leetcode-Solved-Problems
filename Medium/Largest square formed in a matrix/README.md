<h2><a href="https://www.geeksforgeeks.org/problems/largest-square-formed-in-a-matrix0806/1?page=2&category=Dynamic%20Programming&status=solved&sortBy=submissions">Largest square formed in a matrix</a></h2><h3>Difficulty Level : Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a binary matrix <strong>mat</strong>&nbsp;of size <strong>n</strong> * <strong>m</strong>, find out the maximum length of a side of square sub-matrix with all 1s.</span></p>
